...
const Dashboard = () => {
  ...
  const chartData = transactions
    ...
    .reverse()
    .map(t => ({
      name: format(parseISO(t.date), 'dd/MM'),
  ...
  return (
    <div className="space-y-6 pb-24">
      {/* Header Summary */}
      <div className="bg-black text-white p-6 rounded-b-[2.5rem] shadow-lg -mx-4 pt-12">
        <div className="flex items-center justify-between">
          <p className="text-slate-400 text-sm font-medium">Saldo Total</p>
          <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">{currentMonthName}</p>
        </div>
        <h2 className={cn(
          "text-3xl font-bold mt-1 transition-colors duration-500",
      ...
      <div className="bg-white p-6 rounded-3xl card-shadow">
        <h3 className="text-slate-800 font-semibold mb-4 text-sm">Fluxo de Caixa</h3>
      ...
      {pieData.length > 0 && (
        <div className="bg-white p-6 rounded-3xl card-shadow">
          <h3 className="text-slate-800 font-semibold mb-4 text-sm">Gastos por Categoria</h3>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between px-2">
          <h3 className="text-slate-800 font-semibold text-sm">Transações Recentes</h3>
          <button className="text-black text-xs font-medium flex items-center gap-1">
            Ver tudo <ChevronRight size={14} />
          </button>
        </div>
        <div className="space-y-3">
          {transactions.length === 0 ? (
            <div className="bg-white p-8 rounded-2xl text-center card-shadow">
            ...
            transactions.slice(0, 5).map((t) => {
              ...
              return (
                <div key={t.id} className="bg-white p-4 rounded-3xl flex items-center justify-between card-shadow border border-slate-50 group hover:translate-x-1 transition-transform">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <p className="text-slate-400 text-[10px] font-medium">{format(parseISO(t.date), 'dd MMM', { locale: ptBR })}</p>
  ...
  return (
    <div className="pt-12 pb-24 space-y-10">
      <div className="mb-8 px-2">
        <h2 className="text-3xl font-bold text-slate-800 tracking-tight">Gráficos</h2>
    ...
    <div className="pt-12 pb-24 space-y-8">
      ...
      <div className="space-y-4">
        {sortedTransactions.length === 0 ? (
          <div className="bg-white p-12 rounded-[3rem] text-center card-shadow">
  ...
  return (
    <div className="pt-12 pb-24 space-y-8">
      <div className="mb-8">
        ...
        <p className="text-slate-400 text-sm mt-1">Personalize sua experiência financeira</p>
      </div>
...
const AppContent = () => {
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-slate-50 relative overflow-x-hidden">
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white/80 backdrop-blur-xl border-t border-slate-100 px-8 py-4 flex items-center justify-between z-40">
        <button 
